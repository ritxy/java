...
public class XmlUnmarshalling {
	...
	public Forminfo getXmlDataFromFile() {
		...
		try {
			...
			Logger.getLogger(XmlUnmarshalling.class.getName()).log(Level.INFO, "getXmlDataFromFile, xmlFile: {0}",
					forminfo);
		} catch (Exception e) {
	...
	public Forminfo getXmlDataFromString(String xmlString) {
		...
		try {
			Logger.getLogger(XmlUnmarshalling.class.getName()).log(Level.INFO, "getXmlDataFromString, xmlString: {0}",
					xmlString);
			...
			Logger.getLogger(XmlUnmarshalling.class.getName()).log(Level.INFO, "getXmlDataFromString, xmlFile {0}",
					forminfo);
		} catch (Exception e) {
